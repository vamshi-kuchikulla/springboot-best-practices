...
import com.springtechie.dto.ProductRequestDTO;
import com.springtechie.dto.ProductResponseDTO;
import com.springtechie.entity.Product;
import com.springtechie.exception.ProductNotFoundException;
import com.springtechie.exception.ProductServiceBusinessException;
import com.springtechie.repository.ProductRepository;
import com.springtechie.util.ValueMapper;
...
//            }
    ...
    public Map<String, List<ProductResponseDTO>> getProductsByTypes() {
        try {
            ...
            Map<String, List<ProductResponseDTO>> productsMap = productRepository.findAll().stream().map(ValueMapper::convertToDTO).filter(productResponseDTO -> productResponseDTO.getProductType() != null).collect(Collectors.groupingBy(ProductResponseDTO::getProductType));
